...
int main(){
    ...
    */
    ...
    /*
     	* Set up a simple loop that accepts any connection and prints whatever is sent to it to the terminal:
        * This lacks error handling, but it's just a very very simple example
    */
#ifdef _WIN32
        WSADATA wsaData = {0};
